...
class DT_record():
    ...
    def __count_saved_misses(self, lst):
        ...
        while indx<l:
            ...
            total+=miss
        return total
    # def __count_saved_misses(self, lst):# this function is not needed in the latest version
    #     temp=[]
    #     cnt=0
    #     cm=0
    #     for item in lst:
...
class ghidra_bcpi():
    ...
    # def __findDTbyname(self, DTname):# This function is not needed in the latest version
    #     datatype_lst=[]
